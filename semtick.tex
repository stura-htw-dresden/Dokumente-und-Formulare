...
%%------------------------------------------------------------------------------
	...
	{\LARGE\textsf Antrag auf~
		...
		\CheckBox[name=antragnachkauf]{Nachkauf/Wiedernutzung}}\\
...
%% Grund
%%------------------------------------------------------------------------------
\begin{InfoBlock}{Befreiungs-/Erstattungsgrund/Nachkauf/Wiedernutzung \nachweis{Nachweise in Klammern}}
	...
	\CheckBox[name=begruedungnachkauf]{Nachkauf/Wiedernutzung}
